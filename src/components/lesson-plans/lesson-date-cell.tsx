...
export function LessonDateCell({
  ...
  return (
    <Input
      ...
      className="h-8 w-36 rounded-full border-dashed border-au-line bg-au-card-2 px-3 text-xs text-au-ink transition-colors focus-visible:border-solid focus-visible:border-au-accent focus-visible:ring-0 disabled:border-solid disabled:bg-white/[0.03] disabled:opacity-70 [color-scheme:dark]"
    />
  );
}
