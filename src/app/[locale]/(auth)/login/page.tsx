    ...
    <>
      <div className="flex w-full max-w-md flex-col gap-4">
        {(suspended || starFrozen) && (
          <div className="rounded-2xl border border-red-400/30 bg-red-500/15 px-4 py-3 text-center text-sm text-red-700 shadow-sm">
      ...
      <span className="fixed right-8 bottom-6 text-sm font-light tracking-widest text-au-muted italic opacity-90 select-none pointer-events-none">
